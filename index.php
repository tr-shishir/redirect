<html lang="en">
  <head>
    ...
    <title>NKII - Najjači Klan Iđe Ikad</title>
...
<!-- Navigacija -->
    ...
    <div class="container">
    <div class="col-lg-12">
      <img class="img-responsive center-block" src="https://api-assets.clashofclans.com/badges/200/m44uEqux13r-GkmdXdko2y7fil8p0S57uwKJJbHVZnc.png"></img>
      <div class="intro-text">
        <span class="naslov text-center">NKII - Najjaci Klan Idje Ikad</span>
        
        <p class="tekst text-center">24/7 WAR! Dakle, klan za rat. Najjači klan iđe ikad. <br>1000+ trofeja za ulaz, 4+ level trupe se doniraju. <br>Ako ih nemaš, obratiće ti se stević.</p>
  ...
  <section id="about">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6">
         <img src="http://cdn.supercell.com/supercell.com/151120111628/all/themes/supercell/img/bg_clashofclans_character.png" class="img-responsive" alt="">
        </div>
        <div class="col-lg-6">
      ...
      <div class="row">
        ...
        <div class="row">
          ...
          <a href="#" class="thumbnail">
            <img src="http://fakeimg.pl/270x190/?text=NKII%20portfolio%201&font=lato" alt="Portfolio 1">
          </a>
        </div>
          
          <div class="col-xs-6 col-md-3">
          <a href="#" class="thumbnail">
            <img src="http://fakeimg.pl/270x190/?text=NKII%20portfolio%202&font=lato" alt="Portfolio 2">
          </a>
        </div>
          
          <div class="col-xs-6 col-md-3">
          <a href="#" class="thumbnail">
            <img src="http://fakeimg.pl/270x190/?text=NKII%20portfolio%203&font=lato" alt="Portfolio 3">
          </a>
        </div>
          
          <div class="col-xs-6 col-md-3">
          <a href="#" class="thumbnail">
            <img src="http://fakeimg.pl/270x190/?text=NKII%20portfolio%204&font=lato" alt="Portfolio 4">
          </a>
        </div>
          
          <div class="col-xs-6 col-md-3">
          <a href="#" class="thumbnail">
            <img src="http://fakeimg.pl/270x190/?text=NKII%20portfolio%205&font=lato" alt="Portfolio 5">
          </a>
        </div>
          
          <div class="col-xs-6 col-md-3">
          <a href="#" class="thumbnail">
            <img src="http://fakeimg.pl/270x190/?text=NKII%20portfolio%206&font=lato" alt="Portfolio 6">
          </a>
        </div>
          
          <div class="col-xs-6 col-md-3">
          <a href="#" class="thumbnail">
            <img src="http://fakeimg.pl/270x190/?text=NKII%20portfolio%207&font=lato" alt="Portfolio 7">
          </a>
        </div>
          
          <div class="col-xs-6 col-md-3">
          <a href="#" class="thumbnail">
            <img src="http://fakeimg.pl/270x190/?text=NKII%20portfolio%208&font=lato" alt="Portfolio 8">
          </a>
        </div>
  ...
  <section id="contact">
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-6">
        <p>Page was created as a project "<strong>
          Zipline: Build a Personal Portfolio Webpage</strong>" for Free Code Camp</p>
          
          <p>If you need to get in touch with me,<br> try email ruzicic [@] gmail [.] com</p>  
        </div>
